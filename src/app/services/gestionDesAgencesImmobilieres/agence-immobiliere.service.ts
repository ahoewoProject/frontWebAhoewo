...
export class AgenceImmobiliereService {
  ...
  addAgenceImmobiliere(a: AgenceImmobiliere): Observable<AgenceImmobiliere>{
  ...
  updateAgenceImmobiliere(id: number, a: AgenceImmobiliere): Observable<AgenceImmobiliere>{
  ...
  countAgenceImmobiliere(): Observable<number>{
    return this.httpClient.get<number>(this.url + 'count/agence-immobiliere');
  };
}
